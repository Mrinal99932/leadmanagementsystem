            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="<?php echo base_url();?>adduser1" method="POST" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="lead_email" class="form-control" id="yourEmail" required>
                      <div class="invalid-feedback">Please enter a Email!</div>
                    </div>

                   <div class="col-12">
                      <label for="yourPhone" class="form-label">Lead Phone</label>
                      <input type="phone" name="lead_phone" class="form-control" id="yourPhone" required>
                      <div class="invalid-feedback">Please enter a Phone Number!</div>
                    </div>
					
					<div class="col-12">
                      <label for="yourStatus" class="form-label">Lead Status</label>
                      <input type="text" name="lead_status" class="form-control" id="yourStatus" required>
                      <div class="invalid-feedback">Please enter a Status!</div>
                    </div>
					
					<div class="col-12">
                      <label for="yourStatus" class="form-label">Remark</label>
                      <input type="text" name="remark" class="form-control" id="yourRemark" required>
