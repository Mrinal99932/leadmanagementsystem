            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="<?php echo base_url();?>dologin1" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="<?php echo base_url();?>user_signup">Create an account</a></p>
                    </div>
                  </form>
