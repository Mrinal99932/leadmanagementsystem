...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo base_url();?>resume" class="logo d-flex align-items-center">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo base_url();?>resume">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav1" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?php echo base_url();?>datatable2">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?php echo base_url();?>datatable1">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Update Details</h5>
                    <p class="text-center small">Change your personal details to update account</p>
                  </div>

                  <form class="row g-3 needs-validation" action="<?php echo base_url();?>doupdate" method="POST" novalidate>
                    <div class="col-12">
                      <label for="userName" class="form-label">User Name</label>
                      <input type="text" name="username" value="<?php echo $users['username'];?>" class="form-control" id="username" required>
                      <div class="invalid-feedback">Please, enter your name!</div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Password</label>
                      <input type="password" name="password" value="<?php echo $users['password'];?>" class="form-control" id="yourEmail" required>
                      <div class="invalid-feedback">Please enter a Password!</div>
                    </div>

                    <div class="col-12">
                      <label for="yourRole" class="form-label">Role(admin/agent)</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">role</span>
                        <select name="role">
