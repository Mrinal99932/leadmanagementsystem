...
<head>
  ...
  <title>Pages / Not Found 404 - Lead Management System</title>
  ...
  <main>
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        ...
        <a class="btn" href="<?php echo base_url();?>adminlogin">Login Again</a>
        <img src="<?php echo base_url();?>public/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
        <div class="credits">
