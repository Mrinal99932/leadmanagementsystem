    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Manage Leads</li>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <tr>
               <td><?php echo $user['lead_id']; ?></td>
               <td><?php echo $user['lead_name']; ?></td>
               <td><?php echo $user['lead_email']; ?></td>
			   <td><?php echo $user['lead_phone']; ?></td>
			   <td><?php echo $user['lead_status']; ?></td>
			   <td><?php echo $user['assigned_agent_id']; ?></td>
			   <td><?php echo $user['uploadedby']; ?></td>
			   <td><?php echo $user['remark']; ?></td>
			   <td><?php echo"<a href='".base_url()."del1/".$user['lead_id']."'>Delete</a> | <a href='".base_url()."update1/".$user['lead_id']."'>Edit</a>";?></td>
              </tr>
         <?php endforeach; ?>
         <?php endif; ?>
