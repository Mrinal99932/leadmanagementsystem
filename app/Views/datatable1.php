...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed1" data-bs-target="#tables-nav1" data-bs-toggle="collapse" href="#">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <tr>
			   ...
			   <td><?php echo"<a href='".base_url()."del/".$user['user_id']."'>Delete</a> | <a href='".base_url()."update/".$user['user_id']."'>Edit</a>";?></td>
              </tr>
         <?php endforeach; ?>
         <?php endif; ?>
