...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo base_url();?>agentresume" class="logo d-flex align-items-center">
        <img src="<?php echo base_url();?>public/assets/img/logo.png" alt="">
        <span class="d-none d-lg-block">Lead Management System</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Mrinal Kanti Ganguli</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>Mrinal Kanti Ganguli</h6>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url();?>logout2">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo base_url();?>agentresume">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav1" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Manage Leads</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav1" class="nav-content collapse " data-bs-parent="#sidebar-nav">

          <li>
            <a href="<?php echo base_url();?>viewleads">
              <i class="bi bi-circle"></i><span>View Leads</span>
            </a>
          </li>
		  
		  <li>
            <a href="<?php echo base_url();?>addleads">
              <i class="bi bi-circle"></i><span>Add Leads</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Leads Management System</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Edit Details</h5>
                    <p class="text-center small">Edit your personal details to Edit account</p>
                  </div>

                  <form class="row g-3 needs-validation" action="<?php echo base_url();?>doupdate1" method="POST" novalidate>
                    <div class="col-12">
                      <label for="yourlead_name" class="form-label">Lead Name</label>
                      <input type="text" name="lead_name" value="<?php echo $users['lead_name'];?>" class="form-control" id="lead_name" required>
                      <div class="invalid-feedback">Please, enter your name!</div>
                    </div>

                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Lead Email</label>
                      <input type="email" name="lead_email" value="<?php echo $users['lead_email'];?>" class="form-control" id="yourEmail" required>
                      <div class="invalid-feedback">Please enter a Email!</div>
                    </div>

                   <div class="col-12">
                      <label for="yourPhone" class="form-label">Lead Phone</label>
                      <input type="phone" name="lead_phone" value="<?php echo $users['lead_phone'];?>" class="form-control" id="yourPhone" required>
                      <div class="invalid-feedback">Please enter a Phone Number!</div>
                    </div>
					
					<div class="col-12">
                      <label for="yourStatus" class="form-label">Lead Status</label>
                      <input type="text" name="lead_status" value="<?php echo $users['lead_status'];?>" class="form-control" id="yourStatus" required>
					...
					<div class="col-12">
                      <label for="yourStatus" class="form-label">Remark</label>
                      <input type="text" name="remark" value="<?php echo $users['remark'];?>" class="form-control" id="yourRemark" required>
                      <div class="invalid-feedback">Please enter a Status!</div>
                    </div>
                    ...
                    <div class="col-12">
					<input type="hidden" name="lead_id" value="<?php echo $users['lead_id'];?>">
              ...
              <div class="credits">
                ...
                Designed by <a href="https://www.facebook.com/mrinal.ganguli.7">MKG</a>
              </div>
